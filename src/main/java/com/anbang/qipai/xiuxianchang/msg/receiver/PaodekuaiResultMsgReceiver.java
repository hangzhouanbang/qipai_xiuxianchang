...
import com.anbang.qipai.xiuxianchang.msg.channel.sink.PaodekuaiResultSink;
...
import com.anbang.qipai.xiuxianchang.plan.bean.historicalresult.puke.PaodekuaiJuPlayerResult;
import com.anbang.qipai.xiuxianchang.plan.bean.historicalresult.puke.PaodekuaiPanPlayerResult;
				...
				if (room != null) {
					...
					if (playerList != null) {
						...
						juPlayerResultList.forEach((playerResult) -> {
							PaodekuaiJuPlayerResult pr = (PaodekuaiJuPlayerResult) playerResult;
							try {
